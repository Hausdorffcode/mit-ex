...
def update_hand(hand, word):
    ...
    """
    # TO DO ...
    leftInHand = dict(hand)
    for letter in word:
        leftInHand[letter] = leftInHand.get(letter, 0) - 1
    return leftInHand
#
    ...
    * The final score is displayed.
    ...
    while word != '.': 
        ...
        if not is_valid_word(word, hand, word_list):
            ...
            totalScore += total
            print word + " earned " + str(total) + " points. ",
            print "Total: %i points" % totalScore
    print "Total score: %i points." % totalScore
